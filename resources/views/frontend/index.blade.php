                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="main_slider" data-slick='{"arrows": false}'>
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('storage/banner/'.$data->photo) }}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>{{ $data->title }}</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">{{ $data->description }}</p>
